<template>
    <el-form ref="form" :model="form" label-width="80px" style="width:90%;border:0.1px solid #f1e7e7;margin-left: 5%" id="elform" size="mini" >
        <el-form-item  style="text-align: center;">
            <span style="font-size:30px">变课申请</span>
        </el-form-item>
